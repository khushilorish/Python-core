...
arr_ones = np.ones((3)) #array of 2 rows and 3 columns with all values as one will be created
print("Array of 1's: ",arr_ones)

arr_value = np.full(4,3) #array of 2 rows and 3 columns with all values as 3 will be created
print("Array of default value: ",arr_value)


#creating a sequenced array
# arr_sequence = np.arrange(1,11,2) #flatten array with numbers 1,3,5.. till 10 will be created
